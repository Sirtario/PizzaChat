...
namespace PIZZA.Hub.Interface
{
    class HubTerminalCommands
    {
        ...
        public int help(string[] input)
        {
            ...
            HubTerminal.Cout(ConsoleColor.Green, "##---------------------------------------------------##");
            HubTerminal.Cout(ConsoleColor.Green, "##", false);
            HubTerminal.Cout(ConsoleColor.White, " serverlist             : list all servers         ", false);
            HubTerminal.Cout(ConsoleColor.Green, "##");
            HubTerminal.Cout(ConsoleColor.Green, "##---------------------------------------------------##");
            HubTerminal.Cout(ConsoleColor.Green, "##", false);
            HubTerminal.Cout(ConsoleColor.White, " clientlist             : list all clients         ", false);
            HubTerminal.Cout(ConsoleColor.Green, "##");
            HubTerminal.Cout(ConsoleColor.Green, "##---------------------------------------------------##");
            HubTerminal.Cout(ConsoleColor.Green, "##", false);
            HubTerminal.Cout(ConsoleColor.White, " setpass                : set server password      ", false);
            HubTerminal.Cout(ConsoleColor.Green, "##");
            HubTerminal.Cout(ConsoleColor.Green, "##---------------------------------------------------##");
            HubTerminal.Cout(ConsoleColor.Green, "##", false);
            HubTerminal.Cout(ConsoleColor.White, " removehost {id}        : remove a host by id      ", false);
            HubTerminal.Cout(ConsoleColor.Green, "##");
            HubTerminal.Cout(ConsoleColor.Green, "#######################################################");
            return 0;
        }
